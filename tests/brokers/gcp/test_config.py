...
class TestConfig:
    ...
    def test_environment_variable_config(self) -> None:
        ...
        with patch.dict(
            ...
            try:
                ...
                broker = GCPBroker(project_id="env-project")
    ...
    def test_config_serialization(self) -> None:
        ...
        broker = GCPBroker(project_id="test-serialization")
    ...
    def test_config_immutability(self) -> None:
        ...
        broker = GCPBroker(project_id="immutable-test")
