...
@pytest.mark.gcp()
@require_gcp
class TestParser(GCPTestcaseConfig, LocalCustomParserTestcase):
    ...
    async def test_default_parser_creation(self) -> None:
        ...
        parser = GCPParser()
        assert isinstance(parser, GCPParser)
    ...
    async def test_parse_basic_message(self) -> None:
        ...
        assert isinstance(parsed_msg, GCPMessage)
    ...
    async def test_message_validation(self) -> None:
        ...
        assert isinstance(parsed, GCPMessage)
