...
class AsyncAPI300Factory(SpecificationFactory):
...
def get_3_0_0_spec(broker: BrokerUsecase[Any, Any, Any], **kwargs: Any) -> Specification:
    return FastStream(
        broker,
...
def get_3_0_0_schema(broker: BrokerUsecase[Any, Any, Any], **kwargs: Any) -> Any:
