...
def get_3_0_0_spec(broker: BrokerUsecase[Any, Any]) -> Specification:
    return (
...
def get_3_0_0_schema(broker: BrokerUsecase[Any, Any]) -> Any:
    return get_3_0_0_spec(broker).to_jsonable()
