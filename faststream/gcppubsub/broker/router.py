...
class GCPPubSubPublisher(ArgsContainer):
    """Delayed GCP Pub/Sub publisher registration object.

    Just a copy of `GCPPubSubRegistrator.publisher(...)` arguments.
    """
...
class GCPPubSubRoute(SubscriberRoute):
    """Class to store delayed GCP Pub/Sub subscriber registration.

    Just a copy of `GCPPubSubRegistrator.subscriber(...)` arguments.
    """
