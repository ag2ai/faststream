...
from faststream.gcp.publisher.config import GCPPublisherConfig
from faststream.gcp.publisher.specification import GCPPublisherSpecification
...
class GCPPublisher(PublisherUsecase):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        publisher_config = GCPPublisherConfig(
        ...
        specification = GCPPublisherSpecification(
            topic=topic,
            _outer_config=config,
            title_=title_,
    ...
    async def _publish(
        ...
        *,
        ...
        # Convert generic PublishCommand to GCPPublishCommand if needed
    ...
    async def _ensure_topic_exists(self) -> None:
        ...
        try:
            ...
            if (
                ...
                # Type cast needed since base class expects BrokerConfig but we have GCPBrokerConfig
                config = cast("GCPBrokerConfig", self._outer_config)
                topic_path = (
