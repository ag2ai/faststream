...
To add a new page to this section, simply add a new **Markdown** file to the [`docs/docs/en/howto/confluent`](https://github.com/ag2ai/faststream/tree/main/docs/docs/en/howto/confluent){.external-link target="_blank"} directory and update the [`SUMMARY.md`](https://github.com/ag2ai/faststream/blob/main/docs/docs/SUMMARY.md){.external-link target="_blank"} file.
