...
```python linenums="1"
{! docs_src/redis/stream/pel_testing.py [ln:17-25] !}
```
...
```python linenums="1"
{! docs_src/redis/stream/pel_testing.py [ln:28-37] !}
```
...
```python linenums="1"
{! docs_src/redis/stream/pel_testing.py [ln:52-59] !}
```
...
```python linenums="1"
{! docs_src/redis/stream/pel_testing.py [ln:40-49] !}
```
